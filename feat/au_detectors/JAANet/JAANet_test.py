...
class JAANet(nn.Module):
    ...
    def detect_au(self,imgs,land_data):
        """
        A wrapper function that takes in images and landmarks and uses the model
        to output AU Occurences.
        Args:
            imgs: Processed Image. Shape: (3,H,W)
            land_data: landmark file for the img. 
        Return:
            AUoccur_pred: predictions of occurences for all n Action Units
        """
